@echo off
REM Test script to verify deployment fixes locally (Windows)
...
python -c "import django_filters; print('✅ django-filter is installed')" 2>nul
if errorlevel 1 (
...
python -c "import os; os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'config.settings'); import django; django.setup(); from django.conf import settings; print('CORS_ALLOWED_ORIGINS:', settings.CORS_ALLOWED_ORIGINS); print('✅ CORS configuration loaded successfully')"
echo.
